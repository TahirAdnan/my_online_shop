    ...
    <div class="container-fluid">
        ...
        <form action="{{route('subCategories.index')}}" method="get">
                <div class="card-header">
                    <a href="{{route('subCategories.index')}}" class="btn btn-outline-dark ml-3">Reset</a>
...
<script type="text/javascript">
    // Delete sub_category ajax
    function deleteCategory(id) {
        if (confirm("Are yo sure you want to delete this sub_category")) {
