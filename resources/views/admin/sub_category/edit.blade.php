                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{$sub_catogries->name}}" type="text" name="name" id="name" class="form-control" placeholder="Name">
                                <input value="{{$sub_catogries->id}}" type="hidden" name="id" id="id" class="form-control">                                
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
...
<script type="text/javascript">
    // Validation and sub_catogries store ajax function
